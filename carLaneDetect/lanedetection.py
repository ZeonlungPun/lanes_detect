...
if __name__ =="__main__":
    nx = 6
    ny = 6
    ret, mtx, dist, rvecs, tvecs = getCameraCalibrationCoefficients('./pic/*.JPG', nx, ny)

    #src = np.float32([[580, 460], [700, 460], [1096, 720], [200, 720]])
    src=np.float32([[650,468],[828,468],[1090,714],[290,716]])
    #dst = np.float32([[300, 0], [950, 0], [950, 720], [300, 720]])
    dst = np.float32([[290, 0], [700, 0], [700, 716], [290, 716]])

    video_input = './lane4.mp4'
